...
<div class="preview">
    ...
    <p class="description">
        这是一个能稳定盈利的EA自动交易系统，程序分高中低档，低档保障70%以上的月盈利，如果做不到，点金退费补偿；中档保本不保收益，高档则不做任何保障（收益可能很高，也可能会失去本金）.历史回溯到2017年1月，月模拟收益在70%-200%之间，我们不计算复利，复利看着美好而暴力，实际很难做到。希望以复利计算获取更大盈利的朋友，可自行按2000本金的基础倍数设置资金策略。
    </p>
